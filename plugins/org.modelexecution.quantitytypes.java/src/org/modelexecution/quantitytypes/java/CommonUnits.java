...
//************* SI DERIVED UNITS
	...
	public final static Unit Gray = new Unit(new SIUnit(DerivedUnits.Gray));
	public final static Unit GrayPerSecond = new Unit(new SIUnit(DerivedUnits.GrayPerSecond));
	public final static Unit Becquerel = new Unit(new SIUnit(DerivedUnits.Becquerel));
	public final static Unit MolePerCubicMeter = new Unit(new SIUnit(DerivedUnits.MolePerCubicMeter));
	public final static Unit MolePerKilogram = new Unit(new SIUnit(DerivedUnits.MolePerKilogram));
	public final static Unit RadianPerSecondSquared = new Unit(new SIUnit(DerivedUnits.RadianPerSecondSquared));
	public final static Unit KilogramMeterSquared = new Unit(new SIUnit(DerivedUnits.KilogramMeterSquared));
	public final static Unit JouleSecond = new Unit(new SIUnit(DerivedUnits.JouleSecond));
	public final static Unit RadianPerSecond = new Unit(new SIUnit(DerivedUnits.RadianPerSecond));
	public final static Unit SquareMeter = new Unit(new SIUnit(DerivedUnits.SquareMeter));
	public final static Unit SquareMeterSteradian = new Unit(new SIUnit(DerivedUnits.SquareMeterSteradian));
	public final static Unit SquareMeterKelvin = new Unit(new SIUnit(DerivedUnits.SquareMeterKelvin));
	public final static Unit SquareMeterPerKelvin = new Unit(new SIUnit(DerivedUnits.SquareMeterPerKelvin));
	public final static Unit Farad = new Unit(new SIUnit(DerivedUnits.Farad));
	public final static Unit Katal = new Unit(new SIUnit(DerivedUnits.Katal));
	public final static Unit WattPerSquareMeterKelvin = new Unit(new SIUnit(DerivedUnits.WattPerSquareMeterKelvin));
	public final static Unit KilogramPerCubicMeter = new Unit(new SIUnit(DerivedUnits.KilogramPerCubicMeter));
	public final static Unit Sievert = new Unit(new SIUnit(DerivedUnits.Sievert));
	public final static Unit PascalSecond = new Unit(new SIUnit(DerivedUnits.PascalSecond));
	public final static Unit Coulomb = new Unit(new SIUnit(DerivedUnits.Coulomb));
	public final static Unit CoulombPerMeter = new Unit(new SIUnit(DerivedUnits.CoulombPerMeter));
	public final static Unit CoulombPerCubicMeter = new Unit(new SIUnit(DerivedUnits.CoulombPerCubicMeter));
	public final static Unit CoulombPerMole = new Unit(new SIUnit(DerivedUnits.CoulombPerMole));
	public final static Unit AmperePerSquareMeter = new Unit(new SIUnit(DerivedUnits.AmperePerSquareMeter));
	public final static Unit AmperePerRadian = new Unit(new SIUnit(DerivedUnits.AmperePerRadian));
	public final static Unit CoulombMeter = new Unit(new SIUnit(DerivedUnits.CoulombMeter));
	public final static Unit VoltPerMeter = new Unit(new SIUnit(DerivedUnits.VoltPerMeter));
	public final static Unit CoulombPerSquareMeter = new Unit(new SIUnit(DerivedUnits.CoulombPerSquareMeter));
	public final static Unit Siemens = new Unit(new SIUnit(DerivedUnits.Siemens));
	public final static Unit Volt = new Unit(new SIUnit(DerivedUnits.Volt));
	public final static Unit JoulePerCubicMeter = new Unit(new SIUnit(DerivedUnits.JoulePerCubicMeter));
	public final static Unit Joule = new Unit(new SIUnit(DerivedUnits.Joule));
	public final static Unit JoulePerSquareMeter = new Unit(new SIUnit(DerivedUnits.JoulePerSquareMeter));
	public final static Unit CoulombPerKilogram = new Unit(new SIUnit(DerivedUnits.CoulombPerKilogram));
	public final static Unit Newton = new Unit(new SIUnit(DerivedUnits.Newton));
	public final static Unit NewtonPerCoulomb = new Unit(new SIUnit(DerivedUnits.NewtonPerCoulomb));
	public final static Unit NewtonPerMeter = new Unit(new SIUnit(DerivedUnits.NewtonPerMeter));
	public final static Unit Hertz = new Unit(new SIUnit(DerivedUnits.Hertz));
	public final static Unit CubicMeterPerKilogramSecondSquared = new Unit(new SIUnit(DerivedUnits.CubicMeterPerKilogramSecondSquared));
	public final static Unit JoulePerKelvin = new Unit(new SIUnit(DerivedUnits.JoulePerKelvin));
	public final static Unit Lux = new Unit(new SIUnit(DerivedUnits.Lux));
	public final static Unit Henry = new Unit(new SIUnit(DerivedUnits.Henry));
	public final static Unit PerMole = new Unit(new SIUnit(DerivedUnits.PerMole));
	public final static Unit MeterPerFarad = new Unit(new SIUnit(DerivedUnits.MeterPerFarad));
	public final static Unit SquareMeterPerSecond = new Unit(new SIUnit(DerivedUnits.SquareMeterPerSecond));
	public final static Unit MeterKilogram = new Unit(new SIUnit(DerivedUnits.MeterKilogram));
	public final static Unit MeterKelvin = new Unit(new SIUnit(DerivedUnits.MeterKelvin));
	public final static Unit MeterPerSecondSquared = new Unit(new SIUnit(DerivedUnits.MeterPerSecondSquared));
	public final static Unit KilogramMeterPerSecond = new Unit(new SIUnit(DerivedUnits.KilogramMeterPerSecond));
	public final static Unit MeterPerKelvin = new Unit(new SIUnit(DerivedUnits.MeterPerKelvin));
	public final static Unit MeterPerSecond = new Unit(new SIUnit(DerivedUnits.MeterPerSecond));
	public final static Unit CandelaPerSquareMeter = new Unit(new SIUnit(DerivedUnits.CandelaPerSquareMeter));
	public final static Unit Lumen = new Unit(new SIUnit(DerivedUnits.Lumen));
	public final static Unit JoulePerTesla = new Unit(new SIUnit(DerivedUnits.JoulePerTesla));
	public final static Unit AmpereTurnPerMeter = new Unit(new SIUnit(DerivedUnits.AmpereTurnPerMeter));
	public final static Unit Weber = new Unit(new SIUnit(DerivedUnits.Weber));
	public final static Unit Tesla = new Unit(new SIUnit(DerivedUnits.Tesla));
	public final static Unit AmpereTurn = new Unit(new SIUnit(DerivedUnits.AmpereTurn));
	public final static Unit KilogramKelvin = new Unit(new SIUnit(DerivedUnits.KilogramKelvin));
	public final static Unit KilogramPerSecond = new Unit(new SIUnit(DerivedUnits.KilogramPerSecond));
	public final static Unit KilogramPerSquareMeter = new Unit(new SIUnit(DerivedUnits.KilogramPerSquareMeter));
	public final static Unit KilogramPerMeter = new Unit(new SIUnit(DerivedUnits.KilogramPerMeter));
	public final static Unit JoulePerMole = new Unit(new SIUnit(DerivedUnits.JoulePerMole));
	public final static Unit JoulePerMoleKelvin = new Unit(new SIUnit(DerivedUnits.JoulePerMoleKelvin));
	public final static Unit HenryPerMeter = new Unit(new SIUnit(DerivedUnits.HenryPerMeter));
	public final static Unit FaradPerMeter = new Unit(new SIUnit(DerivedUnits.FaradPerMeter));
	public final static Unit Radian = new Unit(new SIUnit(DerivedUnits.Radian));
	public final static Unit Watt = new Unit(new SIUnit(DerivedUnits.Watt));
	public final static Unit WattPerSteradian = new Unit(new SIUnit(DerivedUnits.WattPerSteradian));
	public final static Unit WattPerSquareMeterSteradian = new Unit(new SIUnit(DerivedUnits.WattPerSquareMeterSteradian));
	public final static Unit WattPerSquareMeter = new Unit(new SIUnit(DerivedUnits.WattPerSquareMeter));
	public final static Unit Pascal = new Unit(new SIUnit(DerivedUnits.Pascal));
	public final static Unit Ohm = new Unit(new SIUnit(DerivedUnits.Ohm));
	public final static Unit Steradian = new Unit(new SIUnit(DerivedUnits.Steradian));
	public final static Unit JoulePerKilogram = new Unit(new SIUnit(DerivedUnits.JoulePerKilogram));
	public final static Unit JoulePerKilogramKelvin = new Unit(new SIUnit(DerivedUnits.JoulePerKilogramKelvin));
	public final static Unit JoulePerKilogramKelvinPerPascal = new Unit(new SIUnit(DerivedUnits.JoulePerKilogramKelvinPerPascal));
	public final static Unit JoulePerKilogramKelvinPerCubicMeter = new Unit(new SIUnit(DerivedUnits.JoulePerKilogramKelvinPerCubicMeter));
	public final static Unit MoleKelvin = new Unit(new SIUnit(DerivedUnits.MoleKelvin));
	public final static Unit WattPerMeterKelvin = new Unit(new SIUnit(DerivedUnits.WattPerMeterKelvin));
	public final static Unit SquareMeterKelvinPerWatt = new Unit(new SIUnit(DerivedUnits.SquareMeterKelvinPerWatt));
	public final static Unit KelvinPerWatt = new Unit(new SIUnit(DerivedUnits.KelvinPerWatt));
	public final static Unit MeterKelvinPerWatt = new Unit(new SIUnit(DerivedUnits.MeterKelvinPerWatt));
	public final static Unit NewtonPerKilogram = new Unit(new SIUnit(DerivedUnits.NewtonPerKilogram));
	public final static Unit SecondTimeSquared = new Unit(new SIUnit(DerivedUnits.SecondTimeSquared));
	public final static Unit NewtonMeter = new Unit(new SIUnit(DerivedUnits.NewtonMeter));
	public final static Unit CubicMeter = new Unit(new SIUnit(DerivedUnits.CubicMeter));
	public final static Unit CubicMeterPerKelvin = new Unit(new SIUnit(DerivedUnits.CubicMeterPerKelvin));
	public final static Unit CubicMeterPerSecond = new Unit(new SIUnit(DerivedUnits.CubicMeterPerSecond));
	public final static Unit JoulePerCubicMeterKelvin = new Unit(new SIUnit(DerivedUnits.JoulePerCubicMeterKelvin));
