...
//**************
	...
	public final static String [] BaseUnitNames ={"Meter", "Kilogram", "Second", "Ampere", "Kelvin", "Mole", "Candela", "Radian"};
	...
	public final static String [] BaseUnitSymbols ={"m", "kg", "s", "A", "K", "mol", "cd", "rad"};
...
//*************
	...
	public SIUnit(){
		Arrays.fill(dimensions, 0.0); //unitless
	}
	...
	public SIUnit(BaseUnits d1, double exp1,BaseUnits d2, double exp2,BaseUnits d3, double exp3,BaseUnits d4, double exp4){
		Arrays.fill(dimensions, 0.0); 
		dimensions[d1.ordinal()] = exp1;		
		dimensions[d2.ordinal()] = exp2;		
		dimensions[d3.ordinal()] = exp3;		
	...
	public SIUnit(BaseUnits d1, double exp1,BaseUnits d2, double exp2,BaseUnits d3, double exp3,BaseUnits d4, double exp4,BaseUnits d5, double exp5){
		Arrays.fill(dimensions, 0.0); 
		dimensions[d1.ordinal()] = exp1;		
		dimensions[d2.ordinal()] = exp2;		
		dimensions[d3.ordinal()] = exp3;		
	...
	public SIUnit(BaseUnits d1, double exp1,BaseUnits d2, double exp2,BaseUnits d3, double exp3,BaseUnits d4, double exp4,BaseUnits d5, double exp5,BaseUnits d6, double exp6){
		Arrays.fill(dimensions, 0.0); 
		dimensions[d1.ordinal()] = exp1;		
		dimensions[d2.ordinal()] = exp2;		
		dimensions[d3.ordinal()] = exp3;		
	...
	public SIUnit(BaseUnits d1, double exp1,BaseUnits d2, double exp2,BaseUnits d3, double exp3,BaseUnits d4, double exp4,BaseUnits d5, double exp5,BaseUnits d6, double exp6,BaseUnits d7, double exp7){
		Arrays.fill(dimensions, 0.0); 
		dimensions[d1.ordinal()] = exp1;		
		dimensions[d2.ordinal()] = exp2;		
		dimensions[d3.ordinal()] = exp3;		
	...
	public DerivedUnits toDerivedUnits(){
		...
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Radian,2.0).equals(this)) //
		...
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,4.0,BaseUnits.Ampere,2.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Ampere,-1.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,-2.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,3,BaseUnits.Ampere,2.0).equals(this))
			return DerivedUnits.Siemens;
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Ampere,1.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Kelvin,-1.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Ampere,-2.0).equals(this))
			return DerivedUnits.Henry;
		if (new SIUnit(BaseUnits.Mole,-1.0).equals(this))
			return DerivedUnits.PerMole;
		if (new SIUnit(BaseUnits.Meter,3,BaseUnits.Kilogram,1.0,BaseUnits.Second,-4,BaseUnits.Ampere,-2.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Ampere,-1.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Mole,-1.0).equals(this))
			return DerivedUnits.JoulePerMole;
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Kelvin,-1.0,BaseUnits.Mole,-1.0).equals(this))
			return DerivedUnits.JoulePerMoleKelvin;
		if (new SIUnit(BaseUnits.Meter,1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Ampere,-2.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Radian,-2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0).equals(this))//
		...
		if (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Ampere,-2.0).equals(this))
			return DerivedUnits.Ohm;
		if (new SIUnit(BaseUnits.Radian,2.0).equals(this))//
		...
		if (new SIUnit(BaseUnits.Meter,1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Kelvin,-1.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,-2.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,3,BaseUnits.Kelvin,1.0).equals(this))
			return DerivedUnits.KelvinPerWatt;
		if (new SIUnit(BaseUnits.Meter,-1.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,3,BaseUnits.Kelvin,1.0).equals(this))
		...
		if (new SIUnit(BaseUnits.Meter,-1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Kelvin,-1.0).equals(this))
	...
	public boolean isDerivedUnit(){
		...
		return (new SIUnit(BaseUnits.Meter,2.0, BaseUnits.Second,-2.0).equals(this)) 
            ...
            || (new SIUnit(BaseUnits.Radian,2.0,BaseUnits.Meter,2.0).equals(this)) //
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kelvin,1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kelvin,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,4.0,BaseUnits.Ampere,2.0).equals(this))
            ...
            || (new SIUnit(BaseUnits.Meter,1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Ampere,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-2.0,BaseUnits.Second,1.0,BaseUnits.Ampere,1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-2.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,3,BaseUnits.Ampere,2.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Ampere,1.0).equals(this))
            ...
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Kelvin,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-2.0,BaseUnits.Candela,1.0,BaseUnits.Radian,1.0).equals(this)) //
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Ampere,-2.0).equals(this))
            || (new SIUnit(BaseUnits.Mole,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,3,BaseUnits.Kilogram,1.0,BaseUnits.Second,-4,BaseUnits.Ampere,-2.0).equals(this))
            ...
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Ampere,-1.0).equals(this))
            ...
            || (new SIUnit(BaseUnits.Kilogram,1.0,BaseUnits.Meter,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Mole,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Kelvin,-1.0,BaseUnits.Mole,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Ampere,-2.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-3.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,4.0,BaseUnits.Ampere,2.0).equals(this))
            ...
            || (new SIUnit(BaseUnits.Radian,-2.0,BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0).equals(this)) //
            || (new SIUnit(BaseUnits.Radian,-2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0).equals(this)) //
            || (new SIUnit(BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Ampere,-2.0).equals(this))
            || (new SIUnit(BaseUnits.Radian,2.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,2.0,BaseUnits.Second,-2.0).equals(this))
            ...
            || (new SIUnit(BaseUnits.Meter,1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-3.0,BaseUnits.Kelvin,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Kilogram,-1.0,BaseUnits.Second,3,BaseUnits.Kelvin,1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-2.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,3,BaseUnits.Kelvin,1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-1.0,BaseUnits.Kilogram,-1.0,BaseUnits.Second,3,BaseUnits.Kelvin,1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,1.0,BaseUnits.Second,-2.0).equals(this))
            ...
            || (new SIUnit(BaseUnits.Meter,3,BaseUnits.Second,-1.0).equals(this))
            || (new SIUnit(BaseUnits.Meter,-1.0,BaseUnits.Kilogram,1.0,BaseUnits.Second,-2.0,BaseUnits.Kelvin,-1.0).equals(this))
			;
	}

	public BaseUnits toBaseUnits() {
		if (new SIUnit(BaseUnits.Meter,1.0).equals(this)) return BaseUnits.Meter;
		if (new SIUnit(BaseUnits.Kilogram,1.0).equals(this)) return BaseUnits.Kilogram;
		if (new SIUnit(BaseUnits.Second,1.0).equals(this)) return BaseUnits.Second;
		if (new SIUnit(BaseUnits.Ampere,1.0).equals(this)) return BaseUnits.Ampere;
		if (new SIUnit(BaseUnits.Kelvin,1.0).equals(this)) return BaseUnits.Kelvin;
		if (new SIUnit(BaseUnits.Mole,1.0).equals(this)) return BaseUnits.Mole;
		if (new SIUnit(BaseUnits.Candela,1.0).equals(this)) return BaseUnits.Candela;
		if (new SIUnit(BaseUnits.Radian,1.0).equals(this)) return BaseUnits.Radian;
		return null;
	}
