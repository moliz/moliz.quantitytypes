...
public UReal divideBy(SpecificHeatVolume r) { //This operation converts first both operands to SI units and then divides)
...
if (r.lt(this)) return new SpecificHeatVolume(r.getX(),r.getU(),r.getUnits());
