...
public UReal divideBy(ThermalResistance r) { //This operation converts first both operands to SI units and then divides)
...
if (r.lt(this)) return new ThermalResistance(r.getX(),r.getU(),r.getUnits());
