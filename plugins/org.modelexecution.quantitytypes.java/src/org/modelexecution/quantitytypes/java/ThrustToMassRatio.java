...
public class ThrustToMassRatio extends Quantity {
...
public ThrustToMassRatio(Quantity q){
value = q.value.clone();
if (!checkUnit(q.unit)) throw new RuntimeException("Invalid Unit for creating a ThrustToMassRatio");
this.unit = new Unit (q.unit);
}
public ThrustToMassRatio () {
value = new UReal();
unit = new Unit(DerivedUnits.NewtonPerKilogram);
}
public ThrustToMassRatio(UReal u){
value = u.clone();
unit = new Unit(DerivedUnits.NewtonPerKilogram);
}
public ThrustToMassRatio(UReal u, Unit unit){
value = u.clone();
if (!checkUnit(unit)) throw new RuntimeException("Invalid Unit for creating an ThrustToMassRatio");
this.unit = new Unit (unit);
}
public ThrustToMassRatio(double x){ //"promotes" a real x
value = new UReal(x);
unit = new Unit(DerivedUnits.NewtonPerKilogram);
}
public ThrustToMassRatio (double x, double u) {
value = new UReal(x,u);
unit = new Unit(DerivedUnits.NewtonPerKilogram);
}
public ThrustToMassRatio(double x, Unit unit){ //we only allow the same Units
value = new UReal(x);
if (!checkUnit(unit)) throw new RuntimeException("Invalid Unit for creating a ThrustToMassRatio");
this.unit = new Unit (unit);
}
public ThrustToMassRatio(double x, double u, Unit unit){
value = new UReal(x,u);
if (!checkUnit(unit)) throw new RuntimeException("Invalid Unit for creating a ThrustToMassRatio");
this.unit = new Unit (unit);
}
public ThrustToMassRatio(String x) { //creates a ThrustToMassRatio from a string representing a real, with u=0.
value = new UReal(x);
unit = new Unit(DerivedUnits.NewtonPerKilogram);
}
public ThrustToMassRatio(String x, String u) { //creates a ThrustToMassRatio from two strings representing (x,u).
value = new UReal(x,u);
unit = new Unit(DerivedUnits.NewtonPerKilogram);
}
public ThrustToMassRatio(String x, String u, Unit unit) { //creates a ThrustToMassRatio from two strings representing (x,u).
value = new UReal(x,u);
if (!checkUnit(unit)) throw new RuntimeException("Invalid Unit for creating a ThrustToMassRatio");
this.unit = new Unit (unit);
}
// Specific Type Operations
public ThrustToMassRatio add(ThrustToMassRatio r) {  //only works if compatible units && operand has no offset
return new ThrustToMassRatio(super.add(r));
}
public ThrustToMassRatio minus(ThrustToMassRatio r) { //only works if compatible units. You can subtract 2 units with offsets, but it returns a DeltaUnit (without offset)
return new ThrustToMassRatio(super.minus(r));
}
...
public UReal divideBy(ThrustToMassRatio r) { //This operation converts first both operands to SI units and then divides)
return super.divideBy(r).value.clone();
}
public ThrustToMassRatio abs() { //units are maintained
return new ThrustToMassRatio(super.abs());
}
public ThrustToMassRatio neg() { //units are maintained
return new ThrustToMassRatio(super.neg());
}
// power(s), and inverse() return Quantity
// lessThan, LessEq, gt, ge all directly from Quantity
public boolean equals(ThrustToMassRatio r) {  
return  r.compatibleUnits(this) && 
this.getUReal().equals(r.convertTo(this.getUnits()).getUReal());
}
public boolean distinct(ThrustToMassRatio r) {
return !(this.equals(r));
}
public ThrustToMassRatio floor() { //returns (i,u) with i the largest int such that (i,u)<=(x,u) -- units maintained
return new ThrustToMassRatio(Math.floor(this.getX()),this.getU(),this.getUnits());
}
public ThrustToMassRatio round(){ //returns (i,u) with i the closest int to x -- units maintained
...
if (r.gt(this)) return new ThrustToMassRatio(r.getX(),r.getU(),r.getUnits());
return new ThrustToMassRatio(this.getX(),this.getU(),this.getUnits());
}
// working with constants (note that add and minus do not work here
public ThrustToMassRatio mult(double r) {
return new ThrustToMassRatio(this.value.mult(new UReal(r)),this.getUnits());
}
public ThrustToMassRatio divideBy(double r) {
return new ThrustToMassRatio(this.value.divideBy(new UReal(r)),this.getUnits());
}
public ThrustToMassRatio mult(UReal r) {
return new ThrustToMassRatio(this.value.mult(r),this.getUnits());
}
public ThrustToMassRatio divideBy(UReal r) {
return new ThrustToMassRatio(this.value.divideBy(r),this.getUnits());
}
// Conversions to basic types: toString, toInteger, toReal, etc. directly from Quantity
public int hashcode(){ //required for equals()
return Math.round((float)value.getX());
}
public ThrustToMassRatio clone() {
return new ThrustToMassRatio(this.getUReal(),this.getUnits());
}
}
